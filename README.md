Welcome to the Cafe and Wifi project repository! This project is developed using Python and Flask, with data retrieval from a database managed through SQLAlchemy.
